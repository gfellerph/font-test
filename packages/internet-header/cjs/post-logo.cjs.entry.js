...
const PostLogo = class {
  ...
  render() {
    var _a;
    if (((_a = store.state.localizedConfig) === null || _a === void 0 ? void 0 : _a.header.logo) === undefined)
      return;
    const config = store.state.localizedConfig.header.logo;
    return (index.h(index.Host, null, index.h(LogoSprite, null), index.h("a", { href: config.logoLink, class: "logo" }, index.h("span", { class: "visually-hidden" }, config.logoLinkTitle), index.h(FaviconSvg, { className: "square-logo" }), index.h("img", { class: "logo-svg full-logo", src: config.logoSvg, alt: config.logoText }))));
  }
...
//# sourceMappingURL=post-logo.cjs.entry.js.map
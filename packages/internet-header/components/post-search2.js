...
const PostSearch = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return postSearchCss; }
}, [1, "post-search", {
    "searchDropdownOpen": [32],
    "coveoSuggestions": [32],
    "placeSuggestions": [32],
    "parcelSuggestion": [32],
    "toggleDropdown": [64],
...
function defineCustomElement() {
  ...
  const components = ["post-search"];
  components.forEach(tagName => { switch (tagName) {
    case "post-search":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PostSearch);
      }
      break;
  } });
}

export { If as I, PostSearch as P, defineCustomElement as d };

//# sourceMappingURL=post-search2.js.map
...
const PostMetaNavigation = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return postMetaNavigationCss; }
}, [1, "post-meta-navigation", {
    "orientation": [1],
...
function defineCustomElement() {
  ...
  const components = ["post-meta-navigation"];
  components.forEach(tagName => { switch (tagName) {
    case "post-meta-navigation":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PostMetaNavigation);
      }
      break;
  } });
}

export { PostMetaNavigation as P, defineCustomElement as d };

//# sourceMappingURL=post-meta-navigation2.js.map
...
import { u as userPrefersReducedMotion } from './ui.service.js';
...
const PostMainNavigation = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement() {
  ...
  const components = ["post-main-navigation"];
...
//# sourceMappingURL=post-main-navigation2.js.map
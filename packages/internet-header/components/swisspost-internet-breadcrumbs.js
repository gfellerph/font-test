...
import { c as clearAllBodyScrollLocks, d as disableBodyScroll, e as enableBodyScroll } from './bodyScrollLock.esm.js';
...
import { p as prefersReducedMotion } from './utils.js';
 ...
 * @returns
 */
const OverlayComponent = (props) => (h("div", { class: "overlay", onClick: () => props.onClick(), onKeyDown: e => props.onKeyDown !== undefined && props.onKeyDown(e), ref: e => e !== undefined && props.overlayRef(e) },
  h("div", { class: "container", role: "dialog" },
    h(FocusTrap, null,
      h("div", { class: "overlay-container", tabindex: "-1" /* For initial focus */, role: "document", onClick: e => e.stopPropagation() },
        h("button", { class: `overlay-close btn-blank d-inline-flex align-items-center nav-link ${props.overlay.id}`, onClick: () => props.onClick() },
          h("span", { class: "visually-hidden" }, props.closeButtonText),
          h(SvgIcon, { name: "pi-close" })),
        h("iframe", { src: props.overlay.target, frameborder: "0", class: "frame", ref: e => e !== undefined && props.iFrameRef(e) }))),
    h("div", { class: "loader-wrapper" },
      h("div", { class: "loader" })))));
...
const MiddleLinks = (props) => {
  return props.items.slice(1, -1).map(item => (h("li", { key: item.url },
    h("a", { href: item.url, class: "nav-link", tabindex: props.focusable === false ? '-1' : undefined },
      h("span", null, item.text)),
    props.icons ? h(SvgIcon, { name: "pi-arrow-down", classNames: "rotate-270" }) : null)));
};

const MiddleDropdown = (props) => {
  return (h("div", { class: "middle-dropdown-container" },
    h("button", { class: "middle-dropdown-button btn btn-blank", type: "button", onClick: event => props.clickHandler(event), tabindex: props.focusable === false ? '-1' : undefined },
      h("span", { class: "visually-hidden" }, translate('Open menu')),
      h("span", { "aria-hidden": "true" }, "...")),
    h(SvgIcon, { name: "pi-arrow-down", classNames: "rotate-270" }),
    props.dropdownOpen ? (h("nav", { class: "middle-dropdown" },
      h("ul", { class: "no-list" },
        h(MiddleLinks, { items: props.items, icons: false, focusable: props.focusable })))) : null));
};
...
const BreadcrumbList = (props) => {
  ...
  return (h("ol", { class: "no-list breadcrumbs-list" },
    h("li", null,
      h("a", { class: "home-link nav-link", href: homeItem.url, tabindex: props.focusable === false ? '-1' : undefined },
        h("span", { class: "visually-hidden" }, homeItem.text),
        h(SvgIcon, { name: "pi-home" })),
      h(SvgIcon, { name: "pi-arrow-down", classNames: "rotate-270" })),
    props.isConcatenated ? (h("li", null,
      h(MiddleDropdown, { items: props.items, dropdownOpen: (_a = props.dropdownOpen) !== null && _a !== void 0 ? _a : false, clickHandler: e => props.clickHandler(e), focusable: props.focusable }))) : (h(MiddleLinks, { items: props.items, icons: true, focusable: props.focusable })),
    h("li", null,
      h("a", { class: "last-link nav-link", href: lastItem.url, tabindex: props.focusable === false ? '-1' : undefined, ref: el => (props.lastItemRef !== undefined ? props.lastItemRef(el) : null) }, lastItem.text))));
};
...
const PostInternetBreadcrumbs = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return postInternetBreadcrumbsCss; }
}, [1, "swisspost-internet-breadcrumbs", {
    "customItems": [1, "custom-items"],
    "customBreadcrumbItems": [32],
    "overlayVisible": [32],
    "isConcatenated": [32],
    "dropdownOpen": [32],
    "refsReady": [32]
...
function defineCustomElement$1() {
  ...
  const components = ["swisspost-internet-breadcrumbs"];
  components.forEach(tagName => { switch (tagName) {
    case "swisspost-internet-breadcrumbs":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PostInternetBreadcrumbs);
      }
      break;
  } });
}

const SwisspostInternetBreadcrumbs = PostInternetBreadcrumbs;
const defineCustomElement = defineCustomElement$1;

export { SwisspostInternetBreadcrumbs, defineCustomElement };

//# sourceMappingURL=swisspost-internet-breadcrumbs.js.map
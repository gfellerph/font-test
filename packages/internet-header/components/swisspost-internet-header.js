...
import { t as throttle, d as debounce } from './index2.js';
import { g as getUserLang, p as persistLanguageChoice } from './language.service.js';
import { u as uniqueId } from './utils.js';
import { s as state, d as dispose } from './store.js';
import { S as SvgSprite } from './svg-sprite.component.js';
import { S as SvgIcon } from './svg-icon.component.js';
import { I as If, d as defineCustomElement$3 } from './post-search2.js';
import { d as defineCustomElement$8 } from './post-klp-login-widget2.js';
import { d as defineCustomElement$7 } from './post-language-switch2.js';
import { d as defineCustomElement$6 } from './post-logo2.js';
import { d as defineCustomElement$5 } from './post-main-navigation2.js';
import { d as defineCustomElement$4 } from './post-meta-navigation2.js';
import { d as defineCustomElement$2 } from './post-skiplinks2.js';
...
const PostInternetHeader = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  /**
  ...
  constructor() {
    ...
    this.__registerHost();
    this.__attachShadow();
    this.headerLoaded = createEvent(this, "headerLoaded", 7);
  ...
  static get style() { return postInternetHeaderCss; }
}, [1, "swisspost-internet-header", {
    "project": [1],
    "stickyness": [1],
    "language": [1],
    "meta": [4],
    ...
    "search": [4],
    "skiplinks": [4],
    "configProxy": [1, "config-proxy"],
    "environment": [1],
    "languageSwitchOverrides": [1, "language-switch-overrides"],
    "customConfig": [1, "custom-config"],
    "languageCookieKey": [1, "language-cookie-key"],
    "languageLocalStorageKey": [1, "language-local-storage-key"],
    "activeRoute": [8, "active-route"],
    "osFlyoutOverrides": [1, "os-flyout-overrides"],
    "fullWidth": [4, "full-width"],
    "activeFlyout": [32],
    "activeDropdownElement": [32],
    "getCurrentLanguage": [64]
  }, [[0, "languageChanged", "handleLanguageChangeEvent"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["swisspost-internet-header", "post-klp-login-widget", "post-language-switch", "post-logo", "post-main-navigation", "post-meta-navigation", "post-search", "post-skiplinks"];
  components.forEach(tagName => { switch (tagName) {
    case "swisspost-internet-header":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, PostInternetHeader);
      }
      break;
    case "post-klp-login-widget":
      if (!customElements.get(tagName)) {
    ...
    case "post-logo":
      ...
      break;
    case "post-main-navigation":
      if (!customElements.get(tagName)) {
        defineCustomElement$5();
      }
      break;
    case "post-meta-navigation":
      if (!customElements.get(tagName)) {
...
const SwisspostInternetHeader = PostInternetHeader;
const defineCustomElement = defineCustomElement$1;

export { SwisspostInternetHeader, defineCustomElement };
